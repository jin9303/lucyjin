          ...
          <ul class="ownmenu">
            <li class="active"><a href="lucy_homeintro.html">HOME</a>
              <ul class="dropdown">
                ...
                <li><a href="lucy_contact.html">Index 3</a></li>
                <li><a href="lucy_intro.html">Index 4</a></li>
    ...
    <section class="section-p-30px blog-page">
      <div class="container"> 
        ...
        <section class="blog-posts blog-detail"> 
          ...
          <!-- Image -->
          <div class="product-slides animate fadeInUp" data-wow-delay="0.4s">
            <div><img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/street_image/27.jpg" alt=""></div>
            <div><img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/street_image/33.jpg" alt=""></div>
          </div>
          
          <!-- Post Content -->
          <div class="post-content animate fadeInUp" data-wow-delay="0.4s"> <span class="tags">FASHION NEWS</span>
            <h2>Standard post with featured image</h2>
            <hr>
            <!-- Post Info -->
            <ul class="info">
            ...
            <!--  Post Feature -->
            <div class="row">
              <div class="col-sm-5"> <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/street_image/36.jpg" alt=""> </div>
              <div class="col-sm-7">
                <h4>Mighty Healthy 2013 Spring/Summer</h4>
            ...
            <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non <br>
              There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>
            
            <!-- Blockquote -->
            <blockquote>Sensibus oportere signiferumque id mea. At usu lucilius phaedrum, vix oratio epicurei ne. Eripuit conceptam sea cu, ius minim delectus euripidis cu. Probo nonumy gubergren id nec. In est probo ridens, his laoreet euripidis et.</blockquote>
            <p>Sea vitae tantas cu, eum eu vide oratio salutatus. Est ad omnis omnes melius, in solet atomorum qui. Meis zril at mei, vel omnis abhorreant ne, eum in aliquando expetendis quaerendum. Est ad voluptaria reprehendunt. Partem ridens delicata qui ut, choro apeirian euripidis his at. Vidisse alterum et nec. At mazim laoreet fuisset qui, ei vix atqui omnes accommodare. <br>
              <br>
              Dicunt quaeque fuisset eam ex, utamur veritus singulis id duo, pro vide appareat efficiantur ex. Case graecis contentiones cu mel. Tritani ocurreret pertinacia pro an. Nibh civibus praesent vix id, odio dolore ad vix, hinc eleifend senserit ea eos. Postea legendos no duo, prima mutat dicant id vis.</p>
          </div>
          
          <!-- Post Auther -->
          <div class="post-auther animate fadeInUp" data-wow-delay="0.4s">
            <div class="media"> 
              
              <!-- Post Auther Img -->
              <div class="media-left"> <a href="#."><img src="<%=ctx%>/resources/sebian-v1.3/images/post-auther-img.jpg" alt=""></a></div>
              <div class="media-body">
                <h5>About Author</h5>
                <a href="#." class="a-name">JAMMIE LANDING</a>
                <p>Sea vitae tantas cu, eum eu vide oratio salutatus. Est ad omnis omnes melius, in solet atomorum qui. Meis zril at mei, vel omnis abhorreant ne, eum in aliquando expetendis quaerendum. Est ad voluptaria reprehendunt. </p>
                <a href="#." class="more">MORE POST BY : JAMMIE LANDING</a> </div>
            </div>
          </div>
          
          <!-- Comments -->
          <div class="comments animate fadeInUp" data-wow-delay="0.4s">
            <h5> <span class="color"> 27</span> COMMENT </h5>
            <ul>
              ...
              <li>
                <div class="media">
                  ...
                  <div class="media-body">
                    <div class="a-com"> <a href="#." class="a-name">JAMMIE LANDING</a>
                      <p>âQuando feugait duo ei, te erant corpora interpretaris eos. Illud accommodare vituperatoribus an mea. Erat mazim animal 
                        at nam, eam te doctus evertitur, sed decore ornatusâ</p>
                      <span class="date">24.03.2015 at 10:21</span> <a href="#." class="btn btn-small btn-dark"> REPLAY</a> </div>
                  </div>
                </div>
              </li>
              ...
              <!-- BTN -->
              <li class="text-center"><a href="#.">MORE COMMENT <i class="caret"></i></a></li>
            </ul>
            
            <!-- Comments Form -->
            <div class="comment-form animate fadeInUp" data-wow-delay="0.4s">
              <h5> POST TO REPLY </h5>
              <form>
                <ul class="row">
                  <li class="col-sm-6">
