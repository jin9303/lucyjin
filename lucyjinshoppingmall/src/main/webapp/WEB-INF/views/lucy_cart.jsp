        ...
        <div class="shopping-cart text-center">
          ...
          <ul class="row cart-details">
            <li class="col-sm-6">
              <div class="media"> 
                <!-- Media Image -->
                <div class="media-left media-middle"> <a href="#." class="item-img"> <img class="media-object" src="<%=ctx%>/resources/sebian-v1.3/images/week-img-3.jpg" alt=""> </a> </div>
          ...
          <div class="btn-sec"> 
            ...
            <!-- CLEAR SHOPPING CART --> 
            <a href="lucy_cart.html" class="btn btn-dark"> <i class="fa fa-trash-o"></i>ì íìí ì­ì íê¸° </a> 
            
            <!-- UPDATE SHOPPING CART --> 
            <a href="lucy_order.html" class="btn btn-dark"> <i class="fa fa-arrow-circle-o-up"></i> ì£¼ë¬¸íê¸° </a> 
            
            <!-- CONTINUE SHOPPING --> 
            <a href="lucy_product_list.html" class="btn btn-dark right-btn"> <i class="fa fa-shopping-cart"></i>ì¼íê³ìíê¸° </a> </div>
