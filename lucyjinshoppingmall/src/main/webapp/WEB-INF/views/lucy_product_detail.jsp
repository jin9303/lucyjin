            ...
            <ul class="dropdown">
              <li>
                <div class="media">
                  ...
                  <div class="media-body">
                    <h6 class="media-heading">íë¼ì í¨í´ ë¸ë¼ì°ì¤</h6>
        ...
        <div class="row"> 
          ...
          <div class="col-sm-6 large-detail animate fadeInLeft" data-wow-delay="0.4s">
            <div class="images-slider">
              <ul class="slides">
                <li data-thumb="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-1.jpg"> <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-1.jpg"  alt=""> </li>
                <li data-thumb="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-2.jpg"> <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-2.jpg"  alt=""> </li>
                <li data-thumb="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-3.jpg"> <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-3.jpg"  alt=""> </li>
                <li data-thumb="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-4.jpg"> <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-4.jpg"  alt=""> </li>
                <li data-thumb="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-5.jpg"> <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/item-detail-img-5.jpg"  alt=""> </li>
              </ul>
            </div>
          </div>
            ...
            <div class="row"> 
              ...
              <div class="col-sm-12">
                <div class="fun-share">
                  ...
                  <a href="lucy_cart.html" class="btn btn-small btn-dark">ADD TO CART</a> <a href="#." class="share-sec"> 	<a href="lucy_cart.html" class="btn btn-small btn-dark">BUY NOW</a><i class="ion-shuffle"></i></a> <a class="share-sec" href="lucy_wishlist.html"><i class="fa fa-heart-o"></i></a> </div>
              </div>
        ...
        <div class="item-decribe animate fadeInUp" data-wow-delay="0.4s">
          <div class="text-center"> 
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation"><a href="lucy_product_image_detail.html" aria-controls="men">detail image</a></li>
...
<script src="<%=ctx%>/resources/sebian-v1.3/js/jquery.elevatezoom.js"></script> 
