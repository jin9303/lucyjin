...
<div id="wrap">
  ...
  <div class="coming-soon">
    <div class="container">
      <div class="avatar animate fadeInUp" data-wow-delay="0.4s"> <img src="<%=ctx%>/resources/sebian-v1.3/images/soon-avatar.png" alt="" > </div>
      <h1 class="animate fadeInUp" data-wow-delay="0.4s">COMMING SOON</h1>
      <h3 class="animate fadeInUp" data-wow-delay="0.4s">We Are Launching Soon</h3>
      <img class="margin-t-40 margin-b-40 animate fadeInUp" data-wow-delay="0.4s" src="<%=ctx%>/resources/sebian-v1.3/images/hammer-soon.png" alt="" >
      <p class="animate fadeInUp" data-wow-delay="0.4s">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. </p>
      <div id="timer">
        <div class="time"> 
...
<script src="<%=ctx%>/resources/sebian-v1.3/js/jquery.flexslider-min.js"></script> <script src="js/jquery.downCount.js"></script> 
...
(function($) {
  "use strict";
	$('.countdown').downCount({
     date: '12/12/2016 12:00:00' // M/D/Y
});
})(jQuery);
</script>
</body>
