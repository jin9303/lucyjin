        ...
        <div class="row"> 
          ...
          <div class="col-sm-3 animate fadeInLeft" data-wow-delay="0.2s">
            <div class="side-bar">
              ...
              <!-- CATEGORIES -->
              <ul class="cate">
                <li><a href="#.">Menâs <span>(32)</span></a></li>
                <li><a href="#.">Woman <span>(9)</span></a> </li>
                <li><a href="#.">Kidâs <span>(25)</span></a> </li>
          ...
          <!--======= ITEMS =========-->
          <div class="col-sm-9 animate fadeInRight" data-wow-delay="0.2s"> 
            
            <!--======= BANNER =========-->
            <section class="small-banr animate fadeInUp" data-wow-delay="0.4s" data-stellar-background-ratio="0.4">
              <div class="position-center-center full-width">
                <h5>HAND-EMBROIDERED TUNIC</h5>
              </div>
            </section>
            ...
            <!--======= Products =========-->
            <div class="popurlar_product list-style animate fadeInUp" data-wow-delay="0.4s">
              <ul>
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="<%=ctx%>/resources/sebian-v1.3/images/new-item-1.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="<%=ctx%>/resources/sebian-v1.3/images/new-item-2.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                        <div class="details-sec"> <a href="#.">LOOSE-FIT TRENCH COAT</a> <span class="font-montserrat">129.00 USD</span> </div>
                        <!-- Rating Stars -->
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="<%=ctx%>/resources/sebian-v1.3/images/new-item-3.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                        <div class="details-sec"> <a href="#.">LOOSE-FIT TRENCH COAT</a> <span class="font-montserrat">129.00 USD</span> </div>
                        <!-- Rating Stars -->
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="<%=ctx%>/resources/sebian-v1.3/images/new-item-4.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                        <div class="details-sec"> <a href="#.">LOOSE-FIT TRENCH COAT</a> <span class="font-montserrat">129.00 USD</span> </div>
                        <!-- Rating Stars -->
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="<%=ctx%>/resources/sebian-v1.3/images/new-item-5.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                        <div class="details-sec"> <a href="#.">LOOSE-FIT TRENCH COAT</a> <span class="font-montserrat">129.00 USD</span> </div>
                        <!-- Rating Stars -->
...
<script src="<%=ctx%>/resources/sebian-v1.3/js/jquery.flexslider-min.js"></script> <script src="js/jquery.nouislider.min.js"></script> 
