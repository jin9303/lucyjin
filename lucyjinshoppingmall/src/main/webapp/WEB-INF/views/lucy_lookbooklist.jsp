...
<div id="wrap">
 ...
 <div class="sticky">
  ...
  <div class="content"> 
    ...
    <!-- Blog -->
    <section class="section-p-30px blog-cols">
      <div class="container">
        <div class="row"> 
          ...
          <div class="col-sm-12"> 
            ...
            <div class="blog-posts">
              <ul class="row">
                ...
                <!--  Posts 1 -->
                <li class="col-sm-6 text-center animate fadeInUp" data-wow-delay="0.4s"> 
                  <!--  Image -->
                  <div class="post-img"> <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/street_image/36.jpg" alt=""> 
                    
                    <!-- Hover Link -->
                    <div class="position-center-center"> <a href="#." class="hove-link"> <i class="fa fa-search"></i></a> </div>
                  </div>
                  <!-- Tag Icon -->
                  <div class="blog-tag-icon"> <i class="fa fa-pencil"></i> </div>
                  <span class="tags">FASHION NEWS</span> <a href="lucy_lookbook_detail.html" class="tittle-post font-playfair">Mighty Healthy 2018 WEDDING</a>
                ...
                <!--  Posts 2 -->
                <li class="col-sm-6 text-center animate fadeInUp" data-wow-delay="0.6s"> 
                  <!--  Image -->
                  <div class="post-img"> 
                    <!-- Hover Link -->
                    <div class="position-center-center"> <a href="#." class="hove-link"> <i class="fa fa-search"></i></a> </div>
                    ...
                    <div class="product-slides">
                      <div><img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/blog-col-2.jpg" alt=""></div>
                      <div><img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/blog-col-3.jpg" alt=""></div>
                      <div><img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/blog-col-1.jpg" alt=""></div>
                    </div>
                  </div>
                  <!-- Tag Icon -->
                  <div class="blog-tag-icon"> <i class="fa fa-picture-o"></i> </div>
                  <span class="tags">FASHION NEWS</span> <a href="lucy_lookbook_ss.html" class="tittle-post font-playfair">Standard post with 2018 SPRING / SUMMER</a>
                  <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia anim. </p>
                  <!--  Post Info -->
                  <ul class="info">
                    <li><i class="fa fa-user"></i> admin</li>
                ...
                <li class="col-sm-6 text-center animate fadeInUp" data-wow-delay="0.4s"> 
                  <!--  Image -->
                  <div class="post-img"> <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/blog-col-3.jpg" alt=""> 
                    
                    <!-- Hover Link -->
                    <div class="position-center-center"> <i class="play-link fa fa-play"></i> </div>
                  </div>
                  <!-- Tag Icon -->
                  <div class="blog-tag-icon"> <i class="fa fa-headphones"></i> </div>
                  <span class="tags">MUSIC</span> <a href="#." class="tittle-post font-playfair">Mighty Standard post with audio</a>
                  <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia anim. </p>
                  <!--  Post Info -->
                  <ul class="info">
                    <li><i class="fa fa-user"></i> admin</li>
                ...
                <li class="col-sm-6 text-center animate fadeInUp" data-wow-delay="0.6s"> 
                  <!--  Image -->
                  <div class="post-img"> <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/blog-col-4.jpg" alt=""> 
                    
                    <!-- Hover Link -->
                    <div class="position-center-center"> <a href="#." class="posti-link">http://fortawesome.github.io/Font-Awesome</a> </div>
                  </div>
                  <!-- Tag Icon -->
                  <div class="blog-tag-icon"> <i class="fa fa-link"></i> </div>
                  <span class="tags">FASHION NEWS</span> <a href="lucy_lookbook_fw.html" class="tittle-post font-playfair">Standard post with 2017 Fall / Winter </a>
                  <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia anim. </p>
                  <!--  Post Info -->
                  <ul class="info">
                    <li><i class="fa fa-user"></i> admin</li>
