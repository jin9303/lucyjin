  ...
  <section class="sub-banner animate fadeInUp" data-wow-delay="0.4s">
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">MY INFO 나의 정보 보기  </li>
      </ol>
    </div>
  </section>
      ...
      <div class="container"> 
        ...
        <div class="contact section-p-30px no-padding-b">
          <div class="contact-form"> 
            <!--======= FORM  =========-->
            <form role="form" id="contact_form" action="<%=ctx%>/member/modifyForm" class="contact-form" method="post" >
            <input type="hidden" class="form-control" name="emailId" id="emailId" value="${myInfo2.emailId}">
            <input type="hidden" class="form-control" name="birthdate" id="birthdate" value="${myInfo2.birthdate}">
            <input type="hidden" class="form-control" name="name" id="name" value="${myInfo2.name}">
            <input type="hidden" class="form-control" name="addr" id="birthdate" value="${myInfo2.addr}">
            <input type="hidden" class="form-control" name="passwd" id="birthdate" value="${myInfo2.passwd}">
            <input type="hidden" class="form-control" name="phone_no" id="birthdate" value="${myInfo2.phone_no}">
            <input type="hidden" class="form-control" name="agree_yn" id="birthdate" value="${myInfo2.agree_yn}">
              <div class="row">
                <div class="col-md-6">
                  <ul class="row">
                    <li class="col-sm-12">
                    ...
                    <li class="col-sm-12">
                    <button type="submit" value="submit" class="btn" id="btn_submit" >수정하기</button>
                      </li>
