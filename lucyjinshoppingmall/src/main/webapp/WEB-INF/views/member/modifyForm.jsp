  ...
  <section class="sub-banner animate fadeInUp" data-wow-delay="0.4s">
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">MY INFO 수정하기 </li>
      </ol>
    </div>
  </section>
      ...
      <div class="container"> 
        ...
        <div class="contact section-p-30px no-padding-b">
          <div class="contact-form"> 
            <!--======= FORM  =========-->
            <form role="form" id="contact_form" action="<%=ctx%>/member/modify" class="contact-form" method="post" >
              <div class="row">
                <div class="col-md-6">
                  <ul class="row">
                    <li class="col-sm-12">
                      <label>
                        <input type="text" class="form-control" name="birthdate" id="birthdate" value="${modify.birthdate}">
                      </label>
                    </li>
                    <li class="col-sm-12">
                      <label>
                        <input type="text" class="form-control" name="name" id="name"  value="${modify.name}">
                      </label>
                    </li>
                    <li class="col-sm-12">
                      <label>
                        <input type="text" class="form-control" name="addr" id="addr" value="${modify.addr}">
                      </label>
                    </li>
                    <li class="col-sm-12">
                      <label>
                        <input type="password" class="form-control" name="passwd" id="passwd" value="${modify.passwd}">
                      </label>
                    </li>
                    <li class="col-sm-12">
                      <label>
                        <input type="text" class="form-control" name="emailId" id="emailId"value="${modify.emailId}">
                      </label>
                    </li>
                    <li class="col-sm-12">
                      <label>
                        <input type="text" class="form-control" name="phone_no" id="phone_no"value="${modify.phone_no}">
                      </label>
                    </li>
                    <li class="col-sm-12">
                    <button type="submit" value="submit" class="btn" id="btn_submit" >수정완료</button>
                      </li>
                       <li class="col-sm-12">
                    <button type="button" value="button" class="btn" onclick="javascript:document.location.href='<%=ctx%>/member/remove?emailId=${modify.emailId}'">회원탈퇴</button>
                      </li>
