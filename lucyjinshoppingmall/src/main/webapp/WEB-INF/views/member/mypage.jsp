              ...
              <ul class="dropdown">
                <li class="row">
                  ...
                  <div class="col-sm-8 no-padding">
                    <input type="search" class="-control" placeholder="Search Here">
    ...
    <section class="section-p-60px portfolio port-wrap portfolio-style-2">
      <div class="container"> 
        ...
        <ul class="nav-links filter filter-style-2 animate fadeInUp" data-wow-delay="0.4s">
          ...
          <li><a href="#" data-filter=".int">MY LUCY</a></li>
          <li><a href="#" data-filter=".arch">ORDER</a></li>
          <li><a href="#" data-filter=".build">CART</a></li>
          <li><a href="#" data-filter=".plumb">COMMUNITY</a></li>
        </ul>
      </div>
      <div class="container"> 
        <!-- Portfolio Row -->
        <ul class="port-folio-row row col-3 items animate fadeInUp" data-wow-delay="0.4s">
          ...
          <li class="item int plumb">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/street_image/1.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-1.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="lucy_cart.html"><i class="fa fa-link"></i></a>
                  <h6>MY CART</h6>
                </div>
              </div>
            </article>
          ...
          <!-- Project 1 -->
          <li class="item  plumb">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/street_image/2.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-2.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="lucy_cart.html"><i class="fa fa-link"></i></a>
                  <h6>MY COUPON</h6>
          ...
          <!-- Project 1 -->
          <li class="item int plumb">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/street_image/3.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-3.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="lucy_wishlist.html"><i class="fa fa-link"></i></a>
                  <h6>MY STYLE</h6>
                </div>
              </div>
            </article>
          ...
          <li class="item  build plumb">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/street_image/4.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-4.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a>
          ...
          <li class="item int arch">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/street_image/12.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-5.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a>
                  <h6>Mieux Derma Art Direction</h6>
                </div>
              </div>
            </article>
          ...
          <!-- Project 1 -->
          <li class="<%=ctx%>/resources/sebian-v1.3/street_image/3.jpg">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/street_image/11.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-6.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="<%=ctx%>/member/myInfo?emailId=wlsgml9303@navaer.com"><i class="fa fa-link"></i></a>
                  <h6>MY INFO</h6>
                   <form action="<%=ctx%>/member/Info">
                  <input type="hidden" name="emailId" value="wlsgml9303@navaer.com">
          ...
          <li class="item int arch build col-sm-3">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/street_image/6.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-7.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a>
                  <h6>Mieux Derma Art Direction</h6>
                </div>
              </div>
            </article>
          ...
          <!-- Project 1 -->
          <li class="item int arch build col-sm-3">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/street_image/9.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-8.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a>
                  <h6>Mieux Derma Art Direction</h6>
                </div>
              </div>
            </article>
          ...
          <!-- Project 1 -->
          <li class="item int arch build col-sm-3">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/street_image/7.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-9.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a>
                  <h6>Mieux Derma Art Direction</h6>
                </div>
              </div>
            </article>
