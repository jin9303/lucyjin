        ...
        <div class="col-sm-6 contact-3 animate fadeInRight" data-wow-delay="0.4s"> 
          ...
          <div class="contact">
            <div class="contact-form"> 
              <!--======= FORM  =========-->
              <form role="form" action="<%=ctx%>/member/login" id="contact_form" class="contact-form" method="post">
                <div class="row">
                  <div class="col-md-12">
                    <ul class="row">
                  ...
                  <div class="col-md-12">
                    <ul class="row">
                      ...
                      <li class="col-sm-12 no-margin">
                        <button type="submit" value="submit" class="btn" id="btn_submit" >LOGIN</button>
                      </li>

                       <li class="col-sm-12 no-margin">
                        <button value="submit" class="btn" id="btn_submit" onClick="javascrip:document.location.href='lucy_join.html';">JOIN</button>
                      </li>
                    </ul>
                  </div>
                </div>
