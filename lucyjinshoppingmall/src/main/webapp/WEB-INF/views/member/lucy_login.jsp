                ...
                <div class="row">
                  <div class="col-md-12">
                    <ul class="row">
                      ...
                      <li class="col-sm-12">
                        <label>
                          <input type="text" class="form-control" name="company" id="company" placeholder="PW">
                        </label>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-12">
                    <ul class="row">
                      ...
                      <li class="col-sm-12 no-margin">
                        <button type="submit" value="submit" class="btn" id="btn_submit" onClick="proceed();">LOGIN</button>
                      </li>

                       <li class="col-sm-12 no-margin">
                        <button type="submit" value="submit" class="btn" id="btn_submit" onClick="javascrip:document.location.href='lucy_join.html';">JOIN</button>
                      </li>
                    </ul>
                  </div>
                </div>
