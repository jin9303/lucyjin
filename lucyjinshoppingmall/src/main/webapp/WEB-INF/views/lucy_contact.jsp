...
<div id="wrap">
  ...
  <section class="sub-banner">
    <div class="container">
      <h4>LUCYJIN CONTACT</h4>
      <!-- Breadcrumb -->
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li class="active">CONTACT LUCYJIN</li>
      </ol>
    </div>
  </section>
      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="col-sm-6 animate fadeInleft" data-wow-delay="0.4s"> 
            ...
            <div class="tittle">
              <h5>GET IN TOUCH</h5>
              <p>Please donât hesitate to contact me if you have any questions, commnets or messages. Iâll try to respond to everything! </p>
            </div>
            <div class="contact">
        ...
        <div class="row animate fadeInUp" data-wow-delay="0.4s"> 
          ...
          <div class="col-md-6">
            <ul class="row">
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/avatar-con-1.jpg" alt=""> 
                <!--  Details -->
                <h5>M_Adnan</h5>
                <p>Support Manager</p>
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/avatar-con-2.jpg" alt=""> 
                <!--  Details -->
                <h5>LADY SANSA</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/avatar-con-3.jpg" alt=""> 
                <!--  Details -->
                <h5>MARRY DOE</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
          ...
          <div class="col-md-6">
            <ul class="row">
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/avatar-con-4.jpg" alt=""> 
                <!--  Details -->
                <h5>DAVID STARK</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/avatar-con-5.jpg" alt=""> 
                <!--  Details -->
                <h5>PETER DOE</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
              ...
              <li class="col-sm-4"> 
                <!--  Image --> 
                <img class="img-responsive" src="<%=ctx%>/resources/sebian-v1.3/images/avatar-con-6.jpg" alt=""> 
                <!--  Details -->
                <h5>JOHNNY DEEP</h5>
                <p>Support Manager</p>
                <span><i class="fa fa-skype"></i> adnan.arif69</span> </li>
...
if ($('#map').length) {
	...
	var marker = new google.maps.Marker({
		...
		map: map,
		tittle: 'Envato',
		icon: <%=ctx%>+'/resources/sebian-v1.3/images/map-locator-1.png'
	});
} else {
	return false;
}
