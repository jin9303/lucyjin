...
<div id="wrap">
  ...
  <div class="content"> 
    ...
    <!--======= Portfolio =========-->
    <section class="section-p-60px portfolio port-wrap portfolio-style-2 portfolio-defult">
      <div class="container"> 
        
        <!--======= NAV LINKS =========-->
        <ul class="nav-links filter filter-style-2 animate fadeInUp" data-wow-delay="0.4s">
          <li><a class="active" href="#." data-filter="*">ìíí ìì±íê¸°</a></li>
          <li><a href="#" data-filter=".int">ë´ê° ìì±í ìííë³´ê¸°</a></li>
         \
        </ul>
      </div>
      <div class="container"> 
        ...
        <ul class="port-folio-row row col-3 items animate fadeInUp" data-wow-delay="0.4s">
          ...
          <li class="item int plumb">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-1.jpg" alt=""> 
              
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-1.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a> </div>
              </div>
              <!-- Project Detail -->
              <div class="defult-info">
                <h6><a href="#"> HUBERT & FISCHER</a></h6>
          ...
          <!-- Project 1 -->
          <li class="item plumb">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-2.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-1.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a> </div>
              </div>
              <!-- Project Detail -->
              <div class="defult-info">
                <h6><a href="#"> Mieux Derma Art Direction</a></h6>
                <p>Gumbo beet greens corn soko endive gumbo gourd. Parsley shallot courgette tatsoi pea sprouts fava bean collard greens danadelion.</p>
              </div>
            </article>
          </li>
          ...
          <!-- Project 1 -->
          <li class="item int plumb">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-3.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-1.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a> </div>
              </div>
          ...
          <li class="item  build plumb">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-5.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-1.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a> </div>
              </div>
              <!-- Project Detail -->
              <div class="defult-info">
                <h6><a href="#"> NAHA Finalist Hairstylist </a></h6>
                <p>Gumbo beet greens corn soko endive gumbo gourd. Parsley shallot courgette tatsoi pea sprouts fava bean collard greens danadelion.</p>
              </div>
            </article>
          </li>
          ...
          <li class="item int arch">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-6.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-1.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a> </div>
              </div>
              <!-- Project Detail -->
              <div class="defult-info">
                <h6><a href="#"> Beautiful Wrinkles</a></h6>
                <p>Gumbo beet greens corn soko endive gumbo gourd. Parsley shallot courgette tatsoi pea sprouts fava bean collard greens danadelion.</p>
              </div>
            </article>
          </li>
          ...
          <!-- Project 1 -->
          <li class="item int arch">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-7.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-1.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a> </div>
              </div>
          ...
          <!-- Project 1 -->
          <li class="item int arch build col-sm-3">
            <article> <img src="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-8.jpg" alt=""> 
              <!-- Hover Info -->
              <div class="hover-port">
                <div class="position-center-center"> <a href="<%=ctx%>/resources/sebian-v1.3/images/portfolio-img-1.jpg" data-lighter><i class="fa fa-search"></i></a> <a href="#."><i class="fa fa-link"></i></a> </div>
              </div>
