        ...
        <div class="col-sm-6 contact-3 animate fadeInRight" data-wow-delay="0.4s"> 
          ...
          <div class="contact">
            <div class="contact-form"> 
              <!--======= FORM  =========-->
              <form role="form" action="<%=ctx%>/manager/login" id="contact_form" class="contact-form" method="post">
                <div class="row">
                  <div class="col-md-12">
                    <ul class="row">
                      ...
                      <li class="col-sm-12">
                        <label>
                          <input type="text" class="form-control" name="passwd" id="passwd" placeholder="PW">
                        </label>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-12">
                    <ul class="row">
                      ...
                      <li class="col-sm-12 no-margin">
                        <button type="submit" value="submit" class="btn" id="btn_submit" >관리자 계정 로그인 </button>
                      </li>

                       <li class="col-sm-12 no-margin">
                       <a href="<%=ctx%>/manager/registerForm">MANAGER계정등록</a>
<!--                         <button class="btn" onclick="javascript:document.location.href='http://www.daum.net'">MANAGER계정등록</button> -->
                      </li>
                    </ul>
                  </div>
                </div>
