            ...
            <li class="shop-cart"><a href="lucy_cart.html"><i class="fa fa-shopping-cart"></i></a> <span class="numb">2</span>
              <ul class="dropdown">
                <li>
                  <div class="media">
                    <div class="media-left">
                      <div class="cart-img"> <a href="lucy_cart.html"> <img class="media-object img-responsive" src=<%=ctx%>/resources/sebian-v1.3/street_image/a4.jpg alt="..."> </a> </div>
                    </div>
                    <div class="media-body">
            ...
            <div class="popurlar_product animate fadeInUp" data-wow-delay="0.4s">
              <ul class="row">
                ...
                <li class="col-sm-6 animate fadeIn" data-wow-delay="0.4s">
                  <div class="items-in"> 
                    <!-- Image --> 
                    <img src="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-1.jpg" alt=""> 
                    <!-- Hover Details -->
                    <div class="over-item">
                      <ul class="animated fadeIn">
                        <li> <a href="<%=ctx%>/resources/sebian-v1.3/street_image/a8.jpg" data-lighter><i class="ion-search"></i></a></li>
                        <li> <a href="lucy_wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                    ...
                    <!-- Item Name -->
                    <div class="details-sec"> <a href="lucy_product_detail.html">íë¼ì í¨í´ ë¸ë¼ì°ì¤</a> <span class="font-montserrat">129.00 USD</span> </div>
                  </div>
                </li>
                ...
                <li class="col-sm-6 animate fadeIn" data-wow-delay="0.6s">
                  <div class="items-in"> 
                    <!--  Tags  -->
                    <div class="off-tag"> SALE</div>
                    <!-- Image --> 
                    <img src="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-2.jpg" alt=""> 
                    <!-- Hover Details -->
                    <div class="over-item">
                      <ul class="animated fadeIn">
                        <li> <a href="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-2.jpg" data-lighter><i class="ion-search"></i></a></li>
                        <li> <a href="lucy_wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                        <li class="full-w"> <a href="lucy_cart.html" class="btn">ADD TO CART</a></li>
                        <!-- Rating Stars -->
                        <li class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></li>
                    ...
                    <!-- Item Name -->
                    <div class="details-sec"> <a href="lucy_product_detail.html">ì½¤ë¹ ì¤í¸ë© ë°ëìí¸</a> <span class="font-montserrat">129.00 USD</span><span class="text-line">129.00 USD</span> </div>
                  </div>
                </li>
                ...
                <li class="col-sm-6 animate fadeIn" data-wow-delay="0.4s">
                  <div class="items-in"> 
                    ...
                    <!-- Image --> 
                    <img src="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-3.jpg" alt=""> 
                    <!-- Hover Details -->
                    <div class="over-item">
                      <ul class="animated fadeIn">
                        <li> <a href="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-3.jpg" data-lighter><i class="ion-search"></i></a></li>
                        <li> <a href="lucy_wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                        <li class="full-w"> <a href="lucy_cart.html" class="btn">ADD TO CART</a></li>
                        <!-- Rating Stars -->
                        <li class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></li>
                    ...
                    <!-- Item Name -->
                    <div class="details-sec"> <a href="lucy_product_detail.html">ì¤í¸ë¼ì´í ë¸ë ì´ì </a> <span class="font-montserrat">129.00 USD</span> </div>
                  </div>
                </li>
                ...
                <li class="col-sm-6 animate fadeIn" data-wow-delay="0.6s">
                  <div class="items-in"> 
                    ...
                    <!-- Image --> 
                    <img src="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-4.jpg" alt=""> 
                    <!-- Hover Details -->
                    <div class="over-item">
                      <ul class="animated fadeIn">
                        <li> <a href="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-4.jpg" data-lighter><i class="ion-search"></i></a></li>
                        <li> <a href="lucy_wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                        <li class="full-w"> <a href="lucy_cart.html" class="btn">ADD TO CART</a></li>
                        <!-- Rating Stars -->
                        <li class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></li>
                    ...
                    <!-- Item Name -->
                    <div class="details-sec"> <a href="lucy_product_detail.html">íë¶ì°© ëíì¼ ì¤í¸ë¼ì´í ìì¸ </a> <span class="font-montserrat">129.00 USD</span><span class="text-line">129.00 USD</span> </div>
                  </div>
                </li>
                ...
                <li class="col-sm-6 animate fadeIn" data-wow-delay="0.4s">
                  <div class="items-in"> 
                    ...
                    <!-- Image --> 
                    <img src="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-5.jpg" alt=""> 
                    <!-- Hover Details -->
                    <div class="over-item">
                      <ul class="animated fadeIn">
                        <li> <a href="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-5.jpg" data-lighter><i class="ion-search"></i></a></li>
                        <li> <a href="lucy_wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                        <li class="full-w"> <a href="lucy_cart.html" class="btn">ADD TO CART</a></li>
                        <!-- Rating Stars -->
                        <li class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></li>
                    ...
                    <!-- Item Name -->
                    <div class="details-sec"> <a href="lucy_product_detail.html">í¨ë¸ë¦­ ìë¤</a> <span class="font-montserrat">129.00 USD</span> </div>
                  </div>
                </li>
                ...
                <li class="col-sm-6 animate fadeIn" data-wow-delay="0.6s">
                  <div class="items-in"> 
                    ...
                    <!-- Image --> 
                    <img src="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-6.jpg" alt=""> 
                    <!-- Hover Details -->
                    <div class="over-item">
                      <ul class="animated fadeIn">
                        <li> <a href="<%=ctx%>/resources/sebian-v1.3/images/item-col-img-6.jpg" data-lighter><i class="ion-search"></i></a></li>
                        <li> <a href="lucy_wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                        <li class="full-w"> <a href="lucy_cart.html" class="btn">ADD TO CART</a></li>
                        <!-- Rating Stars -->
                        <li class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></li>
                    ...
                    <!-- Item Name -->
                    <div class="details-sec"> <a href="lucy_product_detail.html">ìì½ í¼ í´ë¬ì¹ë°±</a> <span class="font-montserrat">129.00 USD</span> </div>
                  </div>
                </li>
              </ul>
            </div>
